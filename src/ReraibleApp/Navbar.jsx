...
export default function Navbar() {
  ...
  <div className='navbar-text'><span><strong className='Reriblesize'>Reraible</strong></span></div>
	...
	placeholder="Collection,item or user"/>
            ...
            <div className=' d-flex NavAllLinks'>
            <MDBNavbarItem>
            ...
            <MDBNavbarItem>
              <MDBDropdown>
                <MDBDropdownToggle tag='a' className='nav-link NLink comm text-nowrap'>
                  Community
                </MDBDropdownToggle>
                <MDBDropdownMenu>
                  <MDBDropdownItem>
            ...
            <MDBNavbarItem className='NavALLbutton'>
